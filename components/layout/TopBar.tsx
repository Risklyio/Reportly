...
function IconMenu() {
  return (
    <svg className="h-[22px] w-[22px]" viewBox="0 0 24 24" fill="none" stroke={STROKE} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
function IconPlus() {
  return (
    <svg className="h-5 w-5 shrink-0" viewBox="0 0 24 24" fill="none" stroke={STROKE} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="flex h-14 items-center justify-between px-4 lg:px-6">
        ...
        <div ref={menuRef} className="relative flex items-center">
          ...
          >
            {MENU_ITEMS.map((item) => (
              <Link
                ...
                className="flex items-center gap-2 whitespace-nowrap rounded-lg px-3 py-2 text-sm text-text transition hover:bg-neutral-200/60"
              >
                <item.Icon />
                {item.label}
              </Link>
          ...
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-lg transition hover:bg-neutral-200/60"
